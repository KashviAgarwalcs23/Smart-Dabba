# Create comprehensive Python code for IoT Water Quality Data Simulator with realistic Bengaluru data
# Based on research findings from multiple sources
...
# Save the simulator code
with open('simulator.py', 'w') as f:
    f.write(simulator_code)

print("✅ Created simulator.py with realistic Bengaluru water quality data")
print("\nKey features implemented:")
print("• Real TDS ranges from DrinkPrime study (e.g., Whitefield: 192-1002 PPM)")
print("• Real hardness ranges (e.g., Electronics City: 8-580 PPM)")
print("• Correlated Ca/Mg values based on hardness calculations")
print("• Different water types: borewell (hard) vs municipal (soft)")
print("• 6 areas with 200 records each = 1200 total records")